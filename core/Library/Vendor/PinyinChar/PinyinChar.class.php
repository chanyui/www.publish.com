<?php
namespace Vendor\PinyinChar;

/**
 * 汉字拼音首字母工具类
 * 注： 英文的字串：不变返回(包括数字)     例如 yc123 => YC123
 *      中文字符串：返回拼音首字符        例如 这个是测试 => ZGSCS
...
class PinyinChar
{
    ...
    public function getInitials($str)
    {
        if ($this->_charset == 'utf-8') {
            ...
            preg_match_all('/[\x{4e00}-\x{9fa5}a-zA-Z0-9]/u', iconv('gb2312', 'utf-8', $str), $result);
            $str = implode('', $result[0]);
        }
